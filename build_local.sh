...
export GIT_REPO=innholdstjeneste-backend-api

sam build
sam package --template-file .aws-sam/build/template.yaml --s3-bucket publish-innholdstjeneste-backend-api-publishartifactstorebucket-w53uphl46dbh --s3-prefix svenng --output-template-file sampackaged_raw.yaml
